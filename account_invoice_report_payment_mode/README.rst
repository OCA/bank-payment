...
Add payment mode to Account Invoice Report
==========================================

This module adds several fields to the invoice form, below the Fiscal Position:

* The *Payment Mode* ,

* The *Account Number* associated to the selected Payment Mode.
